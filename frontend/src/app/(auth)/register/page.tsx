...
export default function Register() {
  ...
  // Dynamic visibility toggles for security token fields
          ...
          <div className="hidden md:flex flex-[1.4] relative flex-col justify-between p-12 lg:p-16 text-white rounded-2xl m-3 overflow-hidden bg-[#030303]/90 border border-white/[0.04] shadow-2xl">
            ...
            <div className="relative z-20 space-y-4">
              ...
              <p className="text-sm lg:text-base font-light text-neutral-400 leading-relaxed max-w-[340px]">
                Streamline your development loop. Stop blocking frontends with lagging services—start forging mocks instantly.
              </p>
            </div>
          </div>

          {/* RIGHT: BRUTALIST SMOKED CHROME GLASS FORM PANEL */}
          <div className="flex-1 bg-neutral-950/20 backdrop-blur-2xl border-l border-white/[0.02] flex flex-col items-center justify-center p-8 md:p-12 lg:p-20 overflow-y-auto">
            <div className="w-full max-w-[360px] lg:max-w-[380px] my-auto">
              ...
              <div className="space-y-2 mb-8 text-left">
                ...
                <p className="text-sm text-neutral-500 font-light mt-1">
                  Get started with MockForge today
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {/* Server-Side/Local Auth Error Notification Block */}
                ...
                <div className="space-y-1.5 text-left">
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      disabled={isLoadingAuth}
                      className="absolute right-3.5 top-1/2 -translate-y-1/2 p-1 text-neutral-400 hover:text-neutral-300 transition-colors bg-transparent border-none outline-none cursor-pointer"
                    >
                      {showPassword ? (
                ...
                {/* THEME BLUE NEON ACTION SUBMISSION BUTTON */}
                <button
                  type="submit"
                  disabled={isLoadingAuth}
                ...
                >
                  {/* Sliding In-Fill Background Mask - Accent Blue #2563eb */}
              ...
              <p className="mt-8 text-sm text-neutral-500 text-center font-light">
                ...
                <Link href="/login" className="text-white font-medium hover:underline underline-offset-4 decoration-neutral-500">
                  Sign in
                </Link>
              </p>
